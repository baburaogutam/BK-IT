...
import Page_3 from "./pages/jobs.$jobId.tsx";
import PageLayout_3 from "./pages/jobs.$jobId.pageLayout.tsx";
import Page_4 from "./pages/admin-dashboard.tsx";
import PageLayout_4 from "./pages/admin-dashboard.pageLayout.tsx";
...
const fileNameToRoute = new Map([["./pages/jobs.tsx","/jobs"],["./pages/login.tsx","/login"],["./pages/_index.tsx","/"],["./pages/jobs.$jobId.tsx","/jobs/:jobId"],["./pages/admin-dashboard.tsx","/admin-dashboard"]]);
const fileNameToComponent = new Map([
    ["./pages/jobs.tsx", Page_0],
["./pages/login.tsx", Page_1],
["./pages/_index.tsx", Page_2],
["./pages/jobs.$jobId.tsx", Page_3],
["./pages/admin-dashboard.tsx", Page_4],
  ]);
...
"./pages/jobs.$jobId.tsx": PageLayout_3,
"./pages/admin-dashboard.tsx": PageLayout_4,

      ...
      <div className={styles.container}>
        ...
        <header className={styles.header}>
          ...
          <p className={styles.subtitle}>
            Strong collaborations that power placements, innovation, and
        ...
        <div className={styles.hireCTA}>
          <div className={styles.hireInner}>
            <h3 className={styles.hireTitle}>
              Hire From BKIT Solutions
            </h3>
            <p className={styles.hireDescription}>
              Access a pool of job-ready, industry-trained professionals
              equipped with real-world skills and proven competencies.
            </p>
